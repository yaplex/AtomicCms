<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/Admin/Views/Shared/LiquidAdmin.Master"
    Inherits="System.Web.Mvc.ViewPage<ICollection<CmsSetting>>" %>
                                        ...
                                        <div class="table_wrapper_inner">
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                <tbody>
                                                    ...
                                                    <%
                                                        bool odd = false;
                                                        foreach (CmsSetting entry in Model)
                                                        {
                                                            odd = !odd;
                                                    %>
                                                    <tr class='<%=odd?"first":"second" %>'>
                                                        ...
                                                        <td>
                                                            <%=Html.Encode(entry.Value.Ellipsis(100))%>
                                                        </td>
                                                        <td>
                                                            <div class="actions_menu">
                                                                <ul>
                                                                    <li>
                                                                        <%=Html.ActionLink("Edit", "Edit", "Settings", new {id = entry.Id}, new {@class = "edit"})%>
                                                                    </li>
                                                                    <%--<li>
